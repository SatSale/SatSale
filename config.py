...
donate_title = get_opt("donate_title", None)
index_title = get_opt("index_title", None)
node_title = get_opt("node_title", None)
paybox_font_family = get_opt("paybox_font_family", None)
paybox_background = get_opt("paybox_background", None)
paybox_primary_color = get_opt("paybox_primary_color", None)
paybox_secondary_color = get_opt("paybox_secondary_color", None)
